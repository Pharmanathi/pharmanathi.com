...
class ApiProvider {
  Future<http.Response> initializePayment(BuildContext context, int amount) async {
  ...
  Future<http.Response> verifyPayment(BuildContext context, String reference) async {
    final apiEndpoint = '${http_helpers.apiBaseURL}/payments/verify/$reference/';
    return await http_helpers.ApiHelper.httpRequestWithAuthorization(
