                            ...
                            showDialog(
                              ...
                              builder: (BuildContext context) {
                                return AlertDialog(
                                  ...
                                  content: Text(
                                      "Do you want to proceed with booking the appointment?,note by proceeding you give permision to this Medical Profesional access to both medical and personal information.But they are still confidential"),
                                  actions: [
                                    TextButton(
                                      onPressed: () {
